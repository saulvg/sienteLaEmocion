...
import ModalVoteExperience from '../../Modals/ModalVoteExperience';
            ...
            {bookings.map((book) => {
              ...
              return (
                <li key={book.id} className='my-experience'>
                  <Link to={`/experiences/${book.id}`}>
                    <div
                      className='my-experience-img'
                      style={{
                        backgroundImage: book.photoHeader
                          ? `url(${process.env.REACT_APP_BACKEND}/uploads/${book.photoHeader}`
