...
const HomePage = () =>{
    return(
      <div className="App">
        <Header to={'/listaActividades'} button={'Atrevete'}/>
        <main>
          <section id='we' className='interseccion'>
            <CircleHomePage id={'routeDeQueVaEsto'} clas={'homePage'} href={'#deQueVaEsto'} children={'De que trata esto'}/>
            <CircleHomePage id={'routeComents'} clas={'homePage'} href={'#coments'} children={'Comentarios'}/>
            <CircleHomePage id={'routeNuestrosPrincipios'} clas={'homePage'} href={'#nuestrosPrincipios'} children={'Nuestros principios'}/>
            <CircleHomePage id={'routeQueTeEstaEsperando'} clas={'homePage'} href={'#queTeEstaEsperando'} children={'Que te esta esperando'}/>
          </section>
